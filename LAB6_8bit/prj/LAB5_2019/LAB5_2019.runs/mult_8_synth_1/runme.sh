...
HD_PWD='Y:/Code/github/ASIC-PYNQ/LAB5/prj/LAB5_2019/LAB5_2019.runs/mult_8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_8.tcl
