...
#
# Generated by export_simulation on Tue Oct 21 20:03:12 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './multi_24.sh' script.

./multi_24.sh -reset_run
...
./multi_24.sh -noclean_files

For more information on the script, please type './multi_24.sh -help'.
