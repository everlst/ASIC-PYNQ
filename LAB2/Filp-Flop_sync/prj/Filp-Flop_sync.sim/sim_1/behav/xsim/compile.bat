...
REM
REM Generated by Vivado on Mon Sep 08 17:26:18 +0800 2025
...
echo "xvlog --incr --relax -prj Flop_sync_tb_vlog.prj"
call xvlog  --incr --relax -prj Flop_sync_tb_vlog.prj -log xvlog.log
