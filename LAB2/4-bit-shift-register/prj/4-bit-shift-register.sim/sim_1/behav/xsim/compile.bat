...
REM
REM Generated by Vivado on Mon Sep 08 17:32:07 +0800 2025
...
echo "xvlog --incr --relax -prj ShiftRegister_tb_vlog.prj"
call xvlog  --incr --relax -prj ShiftRegister_tb_vlog.prj -log xvlog.log
