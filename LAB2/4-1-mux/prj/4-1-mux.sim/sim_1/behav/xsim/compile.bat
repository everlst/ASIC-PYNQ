...
REM
REM Generated by Vivado on Mon Sep 08 17:00:42 +0800 2025
...
echo "xvlog --incr --relax -prj Mux41b_tb_vlog.prj"
call xvlog  --incr --relax -prj Mux41b_tb_vlog.prj -log xvlog.log
