...
REM
REM Generated by Vivado on Mon Sep 08 17:18:57 +0800 2025
...
echo "xvlog --incr --relax -prj Encoder_case_tb_vlog.prj"
call xvlog  --incr --relax -prj Encoder_case_tb_vlog.prj -log xvlog.log
