...
HD_PWD='F:/GitHub/ASIC-PYNQ/LAB4/prj/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fc_top_ip_array.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fc_top_ip_array.tcl
