...
#
# Generated by export_simulation on Sat Nov 08 20:00:07 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './weight_ram_rd3.sh' script.

./weight_ram_rd3.sh -reset_run
...
./weight_ram_rd3.sh -noclean_files

For more information on the script, please type './weight_ram_rd3.sh -help'.
