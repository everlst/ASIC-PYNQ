...
HD_PWD='D:/zynq_pro/LAB6_8bit/LAB6_8bit/prj/LAB5_2019/LAB5_2019.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fc_top_ip_with_control.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fc_top_ip_with_control.tcl
