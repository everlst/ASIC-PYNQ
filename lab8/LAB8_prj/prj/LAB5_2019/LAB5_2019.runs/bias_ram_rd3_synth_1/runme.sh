...
HD_PWD='D:/zynq_pro/LAB6_8bit/LAB6_8bit/prj/LAB5_2019/LAB5_2019.runs/bias_ram_rd3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bias_ram_rd3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bias_ram_rd3.tcl
