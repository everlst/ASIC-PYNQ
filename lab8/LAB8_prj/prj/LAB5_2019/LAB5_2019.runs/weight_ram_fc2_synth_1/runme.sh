...
HD_PWD='D:/zynq_pro/LAB6_8bit/LAB6_8bit/prj/LAB5_2019/LAB5_2019.runs/weight_ram_fc2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log weight_ram_fc2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source weight_ram_fc2.tcl
