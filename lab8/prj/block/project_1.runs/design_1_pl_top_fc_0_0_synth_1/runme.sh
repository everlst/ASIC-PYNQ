...
HD_PWD='F:/GitHub/ASIC-PYNQ/lab8/prj/block/project_1.runs/design_1_pl_top_fc_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_pl_top_fc_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_pl_top_fc_0_0.tcl
