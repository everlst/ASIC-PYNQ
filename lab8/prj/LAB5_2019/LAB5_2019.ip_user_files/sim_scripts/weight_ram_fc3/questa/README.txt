...
#
# Generated by export_simulation on Mon Oct 13 16:22:12 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './weight_ram_fc3.sh' script.

./weight_ram_fc3.sh -reset_run
...
./weight_ram_fc3.sh -noclean_files

For more information on the script, please type './weight_ram_fc3.sh -help'.
