...
HD_PWD='Y:/Code/github/ASIC-PYNQ/LAB6/prj/LAB5_2019/LAB5_2019.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fc_top_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fc_top_ip.tcl
