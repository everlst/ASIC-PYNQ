...
#
# Generated by export_simulation on Mon Oct 13 16:20:15 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './bias_weight_fc3.sh' script.

./bias_weight_fc3.sh -reset_run
...
./bias_weight_fc3.sh -noclean_files

For more information on the script, please type './bias_weight_fc3.sh -help'.
