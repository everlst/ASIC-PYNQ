...
#
# Generated by export_simulation on Mon Oct 20 17:16:13 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './input_ram_rd3.sh' script.

./input_ram_rd3.sh -reset_run
...
./input_ram_rd3.sh -noclean_files

For more information on the script, please type './input_ram_rd3.sh -help'.
