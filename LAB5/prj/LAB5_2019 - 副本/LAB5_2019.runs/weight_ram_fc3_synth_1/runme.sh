...
HD_PWD='Y:/Code/github/ASIC-PYNQ/LAB5/prj/LAB5_2019/LAB5_2019.runs/weight_ram_fc3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log weight_ram_fc3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source weight_ram_fc3.tcl
