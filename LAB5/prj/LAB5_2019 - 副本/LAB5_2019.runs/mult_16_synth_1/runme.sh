...
HD_PWD='Y:/Code/github/ASIC-PYNQ/LAB5/prj/LAB5_2019/LAB5_2019.runs/mult_16_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_16.tcl
