...
#
# Generated by export_simulation on Mon Oct 13 16:19:22 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './bias_ram_fc2.sh' script.

./bias_ram_fc2.sh -reset_run
...
./bias_ram_fc2.sh -noclean_files

For more information on the script, please type './bias_ram_fc2.sh -help'.
