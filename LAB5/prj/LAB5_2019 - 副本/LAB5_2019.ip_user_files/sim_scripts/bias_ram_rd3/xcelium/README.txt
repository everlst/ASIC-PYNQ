...
#
# Generated by export_simulation on Mon Oct 13 16:19:48 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './bias_ram_rd3.sh' script.

./bias_ram_rd3.sh -reset_run
...
./bias_ram_rd3.sh -noclean_files

For more information on the script, please type './bias_ram_rd3.sh -help'.
